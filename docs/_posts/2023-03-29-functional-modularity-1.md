...
I count myself fortunate in that I was exposed to programming at all in school, and at the time it was taught with the C++ language. In college when I declared my C.S. major, my class projects were mostly in java. If I had to guess, I'd say it was because the curriculums were on theoretical concepts that were thought to be independent of what language you wrote in, and so to prepare students for industry the college chose the most popular languages used there at the time. But one side-effect of this choice for my education was that I was trained to think in the style that these languages emphasized, which for C++ ISO/IEC 14882:2003 and java 1.5 seems to be what is called an 'imperative object-oriented' style.
