...
Ok, back to programming. this idea of getting use out of pieces you already have instead of writing new pieces is a part of every programming style to some extent. So I think providing some of my own background in "seeking modularity" with programs will showcase some of these contrasting styles as I encountered them, and maybe get you excited in the same way I was excited when I learned about the functional way.
...
Other people have put more thought into describing what imperative and object-oriented mean and since I've based my ideas on their descriptions I'm including them in the footnotes. My working definitions are as follows:

- languages that favor imperative programming expect that you will describe to a computer how it should solve a problem in a way that closely resembles how classical computers work. That is, you have to represent in your program, at a fine level of detail, all of the things that should be stored in memory, what the processor should do with those things, and on what order. Given a list of numbers 1 through 10, you can't say "double every item and then give me the numbers that I can divide by 3." Your program has to be aware of the memory location that stores the list and each of its elements, describe how to visit the elements, and then describe how to update each one for both the doubling and the filtering.
-
